...
require 'swagger_client/models/message_metadata'
require 'swagger_client/models/message_response'
require 'swagger_client/models/message_response_failurereason'
require 'swagger_client/models/messages_response'
require 'swagger_client/models/messages_response_messages'
require 'swagger_client/models/meta_data'
require 'swagger_client/models/query'
require 'swagger_client/models/query_metadata'
...
require 'swagger_client/models/test_response'
