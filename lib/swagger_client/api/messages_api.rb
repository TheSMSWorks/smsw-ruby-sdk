...
module SwaggerClient
  class MessagesApi
    ...
    def get_inbox_messages(query, opts = {})
      data, _status_code, _headers = get_inbox_messages_with_http_info(query, opts)
      return data
    end
    ...
    def get_inbox_messages_with_http_info(query, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MessagesApi.get_inbox_messages ..."
      end
      # verify the required parameter 'query' is set
      if @api_client.config.client_side_validation && query.nil?
        fail ArgumentError, "Missing the required parameter 'query' when calling MessagesApi.get_inbox_messages"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MessagesApi#get_inbox_messages\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
